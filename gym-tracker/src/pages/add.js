          ...
          <Layout>
            {props.isLoading ? (
              ...
              <motion.div
                ...
                className="min-h-screen md:border-2  md:py-4 md:mt-10 rounded-lg border-white/10"
              >
                <div className="w-full md:px-4  text-white">
                  <div className="bg-dark md:rounded-lg border-b-2 min-h-screen md:min-h-0 border-primary/20  md:border-none shadow-md shadow-black/10 p-4 pb-7 md:p-5">
                    <div className="mt-2 pt-2  gap-14 flex flex-col ">
                      <input
